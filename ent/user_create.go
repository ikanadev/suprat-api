...
func (uc *UserCreate) AddMeasurementIDs(ids ...int) *UserCreate {
	uc.mutation.AddMeasurementIDs(ids...)
	return uc
}

// AddMeasurements adds the measurements edges to Measurement.
func (uc *UserCreate) AddMeasurements(m ...*Measurement) *UserCreate {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
	return uc.AddMeasurementIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.MeasurementsIDs(); len(nodes) > 0 {
