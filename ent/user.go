...
func (e UserEdges) MeasurementsOrErr() ([]*Measurement, error) {
	if e.loadedTypes[0] {
...
// QueryMeasurements queries the measurements edge of the User.
func (u *User) QueryMeasurements() *MeasurementQuery {
	return (&UserClient{config: u.config}).QueryMeasurements(u)
}
