...
// The MeasureFunc type is an adapter to allow the use of ordinary
// function as Measure mutator.
type MeasureFunc func(context.Context, *ent.MeasureMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MeasureFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.MeasureMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.MeasureMutation", m)
	}
	return f(ctx, mv)
}

// The MeasurementFunc type is an adapter to allow the use of ordinary
// function as Measurement mutator.
type MeasurementFunc func(context.Context, *ent.MeasurementMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MeasurementFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.MeasurementMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.MeasurementMutation", m)
	}
	return f(ctx, mv)
}
